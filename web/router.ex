defmodule Blog.Router do
  ...
  scope "/message", Blog do
    pipe_through :browser

    get "/compose/:zid", MessageController, :compose
    post "/sendemail/user/:zid", MessageController, :send_email
  end
  scope "/users", Blog do
    pipe_through :browser # Use the default browser stack
    get "/profile/:zid", UserController, :profile
    get "/profile/edit/:zid", UserController, :edit
    post "/update/:zid", UserController, :update
    get "/profile/like/:user_zid", UserController, :like_user
